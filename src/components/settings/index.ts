export { default as OpenSettingsModal } from "./OpenSettingsModal/OpenSettingsModal";
export { default as MainSettingsModal } from "./MainSettingsModal/MainSettingsModal";
